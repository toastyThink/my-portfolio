...
return (
    ...
    <div className="mx-auto max-w-7xl px-6 lg:px-8">
      <div className="mx-auto lg:mx-0 ">
        <h2 className="text-4xl font-bold tracking-tight text-white sm:text-6xl">A Little About Me</h2>
        <p className="text-justify mt-6 text-lg leading-8 text-gray-300">
        I'm a versatile Website Developer seamlessly blending the worlds of technology and design. 
